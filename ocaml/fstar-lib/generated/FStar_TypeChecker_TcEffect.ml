                    ...
                    | FStar_Syntax_Syntax.Tm_arrow
                        ...
                        (match uu___3 with
                         | { FStar_Syntax_Syntax.binder_bv = a;
                             ...
                             FStar_Syntax_Syntax.binder_attrs = uu___6;_}::bs1
                             ->
                             let uu___7 =
                               let uu___8 =
                                 let uu___9 =
                  ...
                  | (n, sig_ts) ->
                      FStar_Errors.with_ctx
                        ...
                        (fun uu___6 ->
                           ...
                           | (sig_us, sig_t, sig_ty) ->
                               let uu___8 =
                                 FStar_Syntax_Subst.open_univ_vars sig_us
                                   sig_t in
                               (match uu___8 with
                                | (us, t) ->
                                    let env =
                                    ...
                                    (match uu___9 with
                                     | (a, u) ->
                                         ...
                                         let k =
                                           ...
                                           FStar_Syntax_Util.arrow bs uu___10 in
                                         let g_eq =
                    ...
                    (log_combinator "signature" signature;
                     (let repr =
                        FStar_Errors.with_ctx
                          ...
                          (fun uu___6 ->
                             let repr_ts =
                               let uu___7 = FStar_Syntax_Util.get_eff_repr ed in
                                       ...
                                       | (a, u) ->
                                           ...
                                           let k =
                                             ...
                                             FStar_Syntax_Util.arrow bs
                                               uu___10 in
                                           let g =
                                             FStar_TypeChecker_Rel.teq env ty
                                               k in
                                           (FStar_TypeChecker_Rel.force_trivial_guard
                                              env g;
                                            (let uu___11 =
                       ...
                       let return_repr =
                         FStar_Errors.with_ctx
                           ...
                           (fun uu___7 ->
                              let return_repr_ts =
                                let uu___8 =
                                  FStar_Syntax_Util.get_return_repr ed in
                             ...
                             (let uu___10 =
                                FStar_Errors.with_ctx
                                  ...
                                  (fun uu___11 ->
                                                     ...
                                                     let uu___17 =
                                                           ...
                                                           ed.FStar_Syntax_Syntax.mname in
                                                       {
                                                         ...
                                                         FStar_Syntax_Syntax.vars
                                                           =
                                                           (uu___18.FStar_Syntax_Syntax.vars);
                                                         FStar_Syntax_Syntax.hash_code
                                                           =
                                                           (uu___18.FStar_Syntax_Syntax.hash_code)
                                                       } in
                                                     ([], uu___17)
                                                 | uu___16 ->
                                                     FStar_Compiler_Effect.failwith
                                     ...
                                     let r =
                                       (FStar_Pervasives_Native.snd
                                          stronger_repr).FStar_Syntax_Syntax.pos in
                                     let uu___12 =
                                                       ...
                                                       | FStar_Syntax_Syntax.Tm_arrow
                                                           ...
                                                           let uu___19 =
                                                                 ...
                                                                 ed.FStar_Syntax_Syntax.mname in
                                                             {
                                                               ...
                                                               FStar_Syntax_Syntax.vars
                                                                 =
                                                                 (uu___20.FStar_Syntax_Syntax.vars);
                                                               FStar_Syntax_Syntax.hash_code
                                                                 =
                                                                 (uu___20.FStar_Syntax_Syntax.hash_code)
                                                             } in
                                                           ([], uu___19)
                                                       | uu___18 ->
                                                           FStar_Compiler_Effect.failwith
