        ...
        (fun uu___1 ->
           ...
           | FStar_Syntax_Syntax.Sig_sugar { FStar_Syntax_Syntax.d = d;_} ->
               ((let uu___3 = FStar_Options.debug_any () in
                 if uu___3
                 then
                   let uu___4 = FStar_Parser_AST.decl_to_string d in
                   FStar_Compiler_Util.print1
                     "GGG ! processing Sig_sugar %s\n" uu___4
                 else ());
                (match d.FStar_Parser_AST.d with
                 ...
                 | FStar_Parser_AST.Include lid ->
                     let dsenv =
                       FStar_Syntax_DsEnv.push_include
                         env.FStar_TypeChecker_Env.dsenv lid in
                     let env1 =
                       {
                         FStar_TypeChecker_Env.solver =
                     ...
                     ([], [], env1)
                 | FStar_Parser_AST.Friend lid -> ([], [], env)
                 | uu___3 ->
                     (FStar_Compiler_Effect.failwith "unrecognized Sig_sugar";
                      ([], [], env))))
                 ...
                 (let ne1 =
                    ...
                    then
                      run_phase1
                        (fun uu___4 ->
                           let ne2 =
                             FStar_Errors.with_ctx "tc_eff_decl phase 1"
                               (fun uu___5 ->
                                  let uu___6 =
                                    let uu___7 =
                                      let uu___8 =
                                    ...
                                    FStar_TypeChecker_Normalize.elim_uvars
                                      env uu___7 in
      ...
      fun from_cache ->
        ...
        (match se.FStar_Syntax_Syntax.sigel with
         ...
         | FStar_Syntax_Syntax.Sig_let uu___1 when
             ...
             -> env
         | uu___1 ->
             let env1 = FStar_TypeChecker_Env.push_sigelt_force env se in
             (match se.FStar_Syntax_Syntax.sigel with
  ...
  fun env0 ->
    fun m ->
      fun iface_exists ->
        ...
        let env1 =
          let uu___ =
            FStar_Syntax_DsEnv.set_current_module
              env0.FStar_TypeChecker_Env.dsenv m.FStar_Syntax_Syntax.name in
          {
            FStar_TypeChecker_Env.solver = (env.FStar_TypeChecker_Env.solver);
            FStar_TypeChecker_Env.range = (env.FStar_TypeChecker_Env.range);
            FStar_TypeChecker_Env.curmodule =
        ...
        let uu___ = tc_partial_modul env1 m in
        match uu___ with
        | (modul, env2) -> finish_partial_modul false iface_exists env2 modul
