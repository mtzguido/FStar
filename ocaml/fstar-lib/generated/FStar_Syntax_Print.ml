...
let (showable_sigelt :
  FStar_Syntax_Syntax.sigelt FStar_Compiler_Show.showable) =
  { FStar_Compiler_Show.show = sigelt_to_string }
let (showable_term : FStar_Syntax_Syntax.term FStar_Compiler_Show.showable) =
  { FStar_Compiler_Show.show = term_to_string }