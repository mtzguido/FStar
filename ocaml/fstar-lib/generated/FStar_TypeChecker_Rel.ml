    ...
    fun prob ->
      let uu___ = wl.tcenv in
      {
        ...
        FStar_TypeChecker_Env.curmodule =
          (uu___.FStar_TypeChecker_Env.curmodule);
        FStar_TypeChecker_Env.gamma =
          ((p_guard_uvar prob).FStar_Syntax_Syntax.ctx_uvar_gamma);
        FStar_TypeChecker_Env.gamma_sig =
          (uu___.FStar_TypeChecker_Env.gamma_sig);
        FStar_TypeChecker_Env.gamma_cache =
          (uu___.FStar_TypeChecker_Env.gamma_cache);
    ...
    fun prob ->
      ...
      | FStar_TypeChecker_Common.TProb p ->
          let uu___ =
            ...
            let uu___2 =
              let uu___3 = term_to_string p.FStar_TypeChecker_Common.lhs in
              let uu___4 =
                let uu___5 =
                  let uu___6 = term_to_string p.FStar_TypeChecker_Common.rhs in
                  [uu___6] in
                (rel_to_string p.FStar_TypeChecker_Common.relation) :: uu___5 in
              uu___3 :: uu___4 in
            uu___1 :: uu___2 in
      ...
      | FStar_TypeChecker_Common.CProb p ->
          ...
          FStar_Compiler_Util.format4 "\n%s:\t%s \n\t\t%s\n\t%s" uu___ uu___1
            (rel_to_string p.FStar_TypeChecker_Common.relation) uu___2
let (prob_to_string' :
...
let (giveup :
  worklist -> lstring -> FStar_TypeChecker_Common.prob -> solution) =
  fun wl ->
    fun reason ->
      fun prob ->
        (let uu___1 =
        ...
        Failed (prob, reason)
let (giveup_lit :
  worklist -> Prims.string -> FStar_TypeChecker_Common.prob -> solution) =
  fun wl ->
    fun reason ->
      fun prob ->
    ...
    fun problem ->
      fun x ->
        fun phi ->
          ...
          | FStar_Pervasives_Native.None ->
              let tcenv = p_env wl (FStar_TypeChecker_Common.TProb problem) in
              let u =
                tcenv.FStar_TypeChecker_Env.universe_of tcenv
...
let (explain :
  worklist -> FStar_TypeChecker_Common.prob -> lstring -> Prims.string) =
  fun wl ->
    fun d ->
      fun s ->
        let uu___ =
           ...
           let uu___2 =
             ...
             | FStar_TypeChecker_Common.TProb tp ->
                 FStar_TypeChecker_Err.print_discrepancy
                   (FStar_TypeChecker_Normalize.term_to_string (p_env wl d1))
                   tp.FStar_TypeChecker_Common.lhs
                   tp.FStar_TypeChecker_Common.rhs
             | FStar_TypeChecker_Common.CProb cp ->
                 FStar_TypeChecker_Err.print_discrepancy
                   (FStar_TypeChecker_Normalize.comp_to_string (p_env wl d1))
    ...
    | (t_base, refopt) ->
        ...
        (match uu___1 with
         | (y, phi) ->
             FStar_Syntax_Syntax.mk
               (FStar_Syntax_Syntax.Tm_refine
                  { FStar_Syntax_Syntax.b = y; FStar_Syntax_Syntax.phi = phi
            ...
            then
              ...
              let uu___7 =
                FStar_Compiler_Util.string_of_bool
                  (wl.tcenv).FStar_TypeChecker_Env.enable_defer_to_tac in
              FStar_Compiler_Util.print3
      ...
      | FStar_TypeChecker_Common.NonTrivial f ->
          ((let uu___1 =
           ...
           (let f1 =
            ...
            (let f2 =
               let g1 = FStar_Syntax_Util.unmeta f1 in
               let g2 =
                 let uu___2 = FStar_Syntax_Util.un_squash g1 in
                 match uu___2 with
                 | FStar_Pervasives_Native.Some g' ->
                     FStar_Syntax_Util.unmeta g'
                 | uu___3 -> g1 in
               match g2.FStar_Syntax_Syntax.n with
               | FStar_Syntax_Syntax.Tm_fvar fv when
                   FStar_Syntax_Syntax.fv_eq_lid fv
                     FStar_Parser_Const.true_lid
                   -> FStar_TypeChecker_Common.Trivial
               | uu___2 -> FStar_TypeChecker_Common.NonTrivial f1 in
             {
                                                  ...
                                                  let uu___5 =
                                                    let uu___6 =
                                                      FStar_Compiler_List.hd
                                                        subcomp_ct.FStar_Syntax_Syntax.comp_univs in
                                                    let uu___7 =
                                                      let uu___8 =
                                                        FStar_Compiler_List.hd
                                                          subcomp_ct.FStar_Syntax_Syntax.effect_args in
          ...
          (match hd with
           ...
           | FStar_TypeChecker_Common.TProb tp ->
               ...
               then
                 ...
                 then solve_t' tp probs1
                 else
                   if probs1.defer_ok = DeferAny
                   then
                     maybe_defer_to_user_tac tp
                     ...
                     then
                       ...
                       solve_rigid_flex_or_flex_rigid_subtyping rank1 tp
                         probs1))
     | FStar_Pervasives_Native.None ->
                      ...
                      then
                        ...
                        (let uu___3 =
                           defer_lit FStar_TypeChecker_Common.Deferred_flex
                             reason (FStar_TypeChecker_Common.TProb prob) wl in
                         solve uu___3)))
        | uu___ ->
            let uu___1 =
...
and (solve_rigid_flex_or_flex_rigid_subtyping :
  FStar_TypeChecker_Common.rank_t -> tprob -> worklist -> solution) =
  fun rank1 ->
    fun tp ->
      fun wl ->
        ...
        (let flip = rank1 = FStar_TypeChecker_Common.Flex_rigid in
         let meet_or_join op ts wl1 =
           let eq_prob t1 t2 wl2 =
             let uu___1 =
               new_problem wl2
                 (p_env wl2 (FStar_TypeChecker_Common.TProb tp)) t1
                 FStar_TypeChecker_Common.EQ t2 FStar_Pervasives_Native.None
                 t1.FStar_Syntax_Syntax.pos "join/meet refinements" in
             match uu___1 with
             | (p, wl3) ->
           ...
           let pairwise t1 t2 wl2 =
             ...
             (let uu___2 =
                head_matches_delta
                  (p_env wl2 (FStar_TypeChecker_Common.TProb tp)) wl2.smt_ok
                  t1 t2 in
              match uu___2 with
              | (mr, ts1) ->
                  (match mr with
                       ...
                       (match uu___3 with
                        | (t11, t21) ->
                            let try_eq t12 t22 wl3 =
                              ...
                              | (t1_hd, t1_args) ->
                                  ...
                                  (match uu___5 with
                                   | (t2_hd, t2_args) ->
                                       if
                                         (FStar_Compiler_List.length t1_args)
                                           <>
                                           (FStar_Compiler_List.length
                                              t2_args)
                                       then FStar_Pervasives_Native.None
                            ...
                            let combine t12 t22 wl3 =
                              let env =
                                p_env wl3 (FStar_TypeChecker_Common.TProb tp) in
                              let uu___4 =
                                   ...
                                   | (t2_base, p2_opt) ->
                                       ...
                                       let combine_refinements t_base p1_opt1
                                         ...
                                         let refine x t =
                                           ...
                                           else FStar_Syntax_Util.refine x t in
                                            ...
                                            (y, phi2)) ->
                                             ...
                                             let env_x =
                                               FStar_TypeChecker_Env.push_bv
                                                 env x1 in
                                             let uu___6 =
                                               apply_op env_x op phi11 phi21 in
                                             refine x1 uu___6
                                         | (FStar_Pervasives_Native.None,
                                            FStar_Pervasives_Native.Some
                                            (x, phi)) ->
                 ...
                 (match ts1 with
                  ...
                  | t::ts2 ->
                      ...
                      (match uu___2 with
                       | (out1, probs', wl3) ->
                           aux
                             (out1, (FStar_Compiler_List.op_At probs probs'),
                               wl3) ts2)) in
           let uu___1 =
                         ...
                         (match uu___5 with
                          ...
                          | FStar_Pervasives_Native.Some (flex_bs, flex_t1)
                              ...
                              ((let uu___7 =
                               ...
                               imitate_arrow
                                 (FStar_TypeChecker_Common.TProb tp) wl1 flex
                                 flex_bs flex_t1
                                 tp.FStar_TypeChecker_Common.relation
                                 this_rigid)))
                  else
              ...
              | uu___3 ->
                  ((let uu___5 =
                   ...
                   (let uu___5 = FStar_Syntax_Util.head_and_args this_flex in
                    ...
                    | (u, _args) ->
                        let env =
                          p_env wl (FStar_TypeChecker_Common.TProb tp) in
                        let uu___6 =
                        ...
                        (match uu___6 with
                         | FStar_Syntax_Syntax.Tm_uvar (ctx_uvar, _subst) ->
                             let equiv t =
                               let uu___7 = FStar_Syntax_Util.head_and_args t in
                               match uu___7 with
                               | (u', uu___8) ->
                                   let uu___9 =
                ...
                | Flex (uu___1, u_lhs, uu___2) ->
                    let imitate_comp bs bs_terms c wl1 =
                      ...
                      | FStar_Syntax_Syntax.Total t ->
                          imitate_tot_or_gtot t FStar_Syntax_Syntax.mk_Total
                            wl1
                      | FStar_Syntax_Syntax.GTotal t ->
                          imitate_tot_or_gtot t FStar_Syntax_Syntax.mk_GTotal
                            wl1
                      | FStar_Syntax_Syntax.Comp ct ->
                          let uu___3 =
                            let uu___4 =
                              ...
                              uu___5 :: (ct.FStar_Syntax_Syntax.effect_args) in
                            FStar_Compiler_List.fold_right
                              (fun uu___5 ->
                                 fun uu___6 ->
                          ...
                          (match uu___3 with
                           | (out_args, wl2) ->
                               ...
                               let ct' =
                                 ...
                                 let uu___5 = FStar_Compiler_List.tl out_args in
                                 let uu___6 =
                     ...
                     | (formals, c) ->
                         let rec aux bs bs_terms formals1 wl1 =
                           ...
                           | [] ->
                               ...
                               (match uu___4 with
                                | (c', wl2) ->
                                    let lhs' = FStar_Syntax_Util.arrow bs c' in
                                    let sol =
                                      let uu___5 =
                                        let uu___6 =
      ...
      fun else_solve ->
        ...
        | Success (uu___1, defer_to_tac, imps) ->
            (FStar_Syntax_Unionfind.commit tx;
             (let wl1 = extend_wl wl [] defer_to_tac imps in solve wl1))
        | Failed (p, s) ->
            (FStar_Syntax_Unionfind.rollback tx; else_solve wl (p, s))
    ...
    fun try_solve ->
      fun then_solve ->
        fun else_solve ->
          ...
          | Success (uu___1, defer_to_tac, imps) ->
              (FStar_Syntax_Unionfind.commit tx;
               (let wl1 = extend_wl wl [] defer_to_tac imps in then_solve wl1))
          | Failed (p, s) ->
              (FStar_Syntax_Unionfind.rollback tx; else_solve wl)
...
and (solve_t : tprob -> worklist -> solution) =
  fun problem ->
    fun wl ->
      ...
      (let uu___1 = compress_tprob wl.tcenv problem in solve_t' uu___1 wl)
                ...
                | Flex (uu___4, ctx_u, args) ->
                    let uu___5 =
                      ...
                      let binder_matches_aqual b aq =
                        match ((b.FStar_Syntax_Syntax.binder_qual), aq) with
                        | (FStar_Pervasives_Native.None,
                            ...
                            (match uu___6 with
                             | FStar_Syntax_Syntax.Tm_name x when
                                 ((FStar_Syntax_Syntax.bv_eq
                                   ...
                                   &&
                                   (bv_not_free_in_args
                                      b.FStar_Syntax_Syntax.binder_bv rhs_tl)
                      ...
                      | (head, args_rhs) ->
                          ...
                          then
                            ...
                            (let i = n_args_rhs - n_args_lhs in
                             ...
                             | (prefix, args_rhs1) ->
                                 let head1 =
                                   FStar_Syntax_Syntax.mk_Tm_app head prefix
                                  ...
                                  | (uvars_head, occurs_ok, uu___9) ->
                                      ...
                                      then
                                        ...
                                        (let uu___11 =
                                           let uu___12 =
                                             let uu___13 =
                                               FStar_Syntax_Free.names head1 in
                                             let uu___14 =
                                               binders_as_bv_set
                                                         ...
                                                         | (uu___24, w, wl1)
                                                             ...
                                                             ((let uu___26 =
                                                              ...
                                                              (let rc =
                                                                 if is_ghost
                                                                 then
                                                                   FStar_Syntax_Util.residual_gtot
                                                                    t_res_lhs
                                                                 else
                                                                   FStar_Syntax_Util.residual_tot
                                                                    t_res_lhs in
    ...
    fun wl ->
      ...
      (let giveup_or_defer1 orig msg = giveup_or_defer orig wl msg in
                                  ...
                                  (match (refinement1, refinement2) with
                                   | (FStar_Pervasives_Native.None,
                                      FStar_Pervasives_Native.None) ->
                                       ...
                                       let d =
                                         let uu___9 =
                                           delta_depth_of_term env head1 in
                                         match uu___9 with
                                         | FStar_Pervasives_Native.None ->
                                             FStar_Pervasives_Native.None
                                         | FStar_Pervasives_Native.Some d1 ->
       ...
       let try_match_heuristic orig wl1 s1 s2 t1t2_opt =
         ...
         let try_solve_branch scrutinee p =
           ...
           | (Flex (_t, uv, _args), wl2) ->
               let uu___2 =
                 FStar_TypeChecker_PatternUtils.pat_as_exp true true env p in
               (match uu___2 with
       ...
       let rigid_rigid_delta torig wl1 head1 head2 t1 t2 =
         ...
         (let uu___2 = head_matches_delta (p_env wl1 orig) wl1.smt_ok t1 t2 in
          match uu___2 with
          | (m, o) ->
              (match (m, o) with
               | (MisMatch uu___3, uu___4) ->
                   let try_reveal_hide t11 t21 =
                     ...
                     let mk_fv_app lid u args r =
                       let fv =
                         FStar_TypeChecker_Env.fvar_of_nonqual_lid wl1.tcenv
                           lid in
                                         ...
                                         let uu___15 =
                                           ...
                                           FStar_Compiler_Util.bind_opt
                                             ...
                                             (fun x ->
                                                ...
                                                FStar_Pervasives_Native.Some
                                                  uu___17) in
                                         FStar_Compiler_Util.dflt "" uu___15 in
                                       FStar_Compiler_Util.format4
           ...
           (match ((t1.FStar_Syntax_Syntax.n), (t2.FStar_Syntax_Syntax.n))
            ...
            | (FStar_Syntax_Syntax.Tm_abs
               { FStar_Syntax_Syntax.bs = bs1;
                 FStar_Syntax_Syntax.body = tbody1;
                 FStar_Syntax_Syntax.rc_opt = lopt1;_},
               FStar_Syntax_Syntax.Tm_abs
               { FStar_Syntax_Syntax.bs = bs2;
                 FStar_Syntax_Syntax.body = tbody2;
                 FStar_Syntax_Syntax.rc_opt = lopt2;_})
                ->
                let mk_t t l uu___7 =
                  match uu___7 with
                  | [] -> t
                ...
                let uu___7 =
                  let uu___8 =
                    head_matches_delta env wl.smt_ok
                      x1.FStar_Syntax_Syntax.sort x2.FStar_Syntax_Syntax.sort in
                  match uu___8 with
            ...
            | (FStar_Syntax_Syntax.Tm_app
               {
                 ...
                 FStar_Syntax_Syntax.args = uu___11;_},
            ...
            | (FStar_Syntax_Syntax.Tm_uvar uu___7, FStar_Syntax_Syntax.Tm_app
               {
                 ...
                 FStar_Syntax_Syntax.args = uu___12;_})
                ->
                let env = p_env wl (FStar_TypeChecker_Common.TProb problem) in
                let uu___13 = ensure_no_uvar_subst env t1 wl in
                (match uu___13 with
            ...
            | (FStar_Syntax_Syntax.Tm_app
               ...
               FStar_Syntax_Syntax.Tm_app
               {
                 ...
                 FStar_Syntax_Syntax.args = uu___16;_})
                ->
                let env = p_env wl (FStar_TypeChecker_Common.TProb problem) in
            ...
            | (FStar_Syntax_Syntax.Tm_match
               { FStar_Syntax_Syntax.scrutinee = s1;
                 FStar_Syntax_Syntax.ret_opt = uu___7;
                 FStar_Syntax_Syntax.brs = brs1;
                 FStar_Syntax_Syntax.rc_opt1 = uu___8;_},
               FStar_Syntax_Syntax.Tm_match
               { FStar_Syntax_Syntax.scrutinee = s2;
                 FStar_Syntax_Syntax.ret_opt = uu___9;
                 FStar_Syntax_Syntax.brs = brs2;
                 FStar_Syntax_Syntax.rc_opt1 = uu___10;_})
                ->
                let by_smt uu___11 =
                                  ...
                                  (let uu___17 =
                                   ...
                                   | ((p11, w11, e1), s) ->
                                       ...
                                       (match uu___18 with
                                        | (p21, w21, e2) ->
                                            let w22 =
                                              FStar_Compiler_Util.map_opt w21
            ...
            | (FStar_Syntax_Syntax.Tm_let uu___7, FStar_Syntax_Syntax.Tm_let
               uu___8) ->
  ...
  fun problem ->
    fun wl ->
                                     ...
                                     (arg_sub_probs, wl3)) ->
                                      ...
                                      (match uu___12 with
                                       | (p, wl4) ->
                                           ((p :: arg_sub_probs), wl4)))
                           c1_comp.FStar_Syntax_Syntax.effect_args
                           c2_comp.FStar_Syntax_Syntax.effect_args ([], wl2) in
                       (match uu___6 with
                        | (arg_sub_probs, wl3) ->
                            let sub_probs =
                              let uu___7 =
                                ...
                                FStar_Compiler_List.op_At [ret_sub_prob]
                                  uu___8 in
                              FStar_Compiler_List.op_At univ_sub_probs uu___7 in
                            let guard =
                              let guard1 =
                                let uu___7 =
      ...
      let should_fail_since_repr_subcomp_not_allowed repr_subcomp_allowed c11
        c21 =
        let uu___ =
          let uu___1 = FStar_TypeChecker_Env.norm_eff_name wl.tcenv c11 in
          let uu___2 = FStar_TypeChecker_Env.norm_eff_name wl.tcenv c21 in
          (uu___1, uu___2) in
        match uu___ with
        | (c12, c22) ->
      ...
      let solve_layered_sub c11 c21 =
        ...
        then solve_eq c11 c21 FStar_TypeChecker_Env.trivial_guard
          ...
          (let r = FStar_TypeChecker_Env.get_range wl.tcenv in
           let uu___2 =
                         ...
                         (match uu___7 with
                          | (c12, g_lift) ->
                              ...
                              (match uu___8 with
                               | (tsopt, k) ->
                                   let num_eff_params =
                                     match ed2.FStar_Syntax_Syntax.signature
                                     with
                          ...
                          (let rec is_uvar t =
                             ...
                             | FStar_Syntax_Syntax.Tm_app
                                 { FStar_Syntax_Syntax.hd = t1;
                                   FStar_Syntax_Syntax.args = uu___10;_}
                                 -> is_uvar t1
                             | uu___10 -> false in
                           FStar_Compiler_List.fold_right2
                             (fun uu___9 ->
        ...
        (let r = FStar_TypeChecker_Env.get_range env in
         ...
         then
           ...
           (let is_null_wp_2 =
            ...
            match uu___3 with
            | (wpc1, wpc2) ->
                let uu___4 = FStar_Compiler_Util.physical_equality wpc1 wpc2 in
                if uu___4
                then
                  let uu___5 =
        ...
        ((let uu___3 =
         ...
         (let uu___3 =
            ...
            | (eff1, eff2) ->
                ...
                if uu___5
                then (c1, c2)
                else FStar_TypeChecker_Normalize.ghost_to_pure2 env (c1, c2) in
          match uu___3 with
          | (c11, c21) ->
              (match ((c11.FStar_Syntax_Syntax.n),
               ...
               | (FStar_Syntax_Syntax.GTotal uu___4, FStar_Syntax_Syntax.Comp
                  uu___5) ->
                   let uu___6 =
                     let uu___7 =
                       let uu___8 =
                   ...
                   solve_c uu___6 wl
               | (FStar_Syntax_Syntax.Total uu___4, FStar_Syntax_Syntax.Comp
                  uu___5) ->
                   let uu___6 =
                     let uu___7 =
                       let uu___8 =
                   ...
                   solve_c uu___6 wl
               | (FStar_Syntax_Syntax.Comp uu___4, FStar_Syntax_Syntax.GTotal
                  uu___5) ->
                   let uu___6 =
                     let uu___7 =
                       let uu___8 =
                   ...
                   solve_c uu___6 wl
               | (FStar_Syntax_Syntax.Comp uu___4, FStar_Syntax_Syntax.Total
                  uu___5) ->
                   let uu___6 =
                     let uu___7 =
                       let uu___8 =
    ...
    fun imp ->
      fun is_tac ->
        fun force_univ_constraints ->
          let uu___ = imp in
          match uu___ with
          | { FStar_TypeChecker_Common.imp_reason = imp_reason;
              FStar_TypeChecker_Common.imp_uvar = imp_uvar;
              FStar_TypeChecker_Common.imp_tm = imp_tm;
              FStar_TypeChecker_Common.imp_range = imp_range;_} ->
                    ...
                    FStar_Compiler_Effect.op_Bar_Greater
                      {
                        ...
                        FStar_TypeChecker_Env.curmodule =
                          (env.FStar_TypeChecker_Env.curmodule);
                        FStar_TypeChecker_Env.gamma =
                          (imp_uvar.FStar_Syntax_Syntax.ctx_uvar_gamma);
                        FStar_TypeChecker_Env.gamma_sig =
                          (env.FStar_TypeChecker_Env.gamma_sig);
                        FStar_TypeChecker_Env.gamma_cache =
                          (env.FStar_TypeChecker_Env.gamma_cache);
                       ...
                       then
                         ...
                         (let uu___4 =
                          ...
                          | FStar_Pervasives.Inl
                              ...
                              {
                                FStar_TypeChecker_Common.guard_f =
                                  (FStar_TypeChecker_Common.NonTrivial g1);
                                FStar_TypeChecker_Common.deferred_to_tac =
