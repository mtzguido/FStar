                   ...
                   let uu___2 =
                     ...
                     FStar_Tactics_Effect.tac_bind
                       ...
                       (fun uu___4 ->
                          FStar_Tactics_Effect.lift_div_tac
                            (fun uu___5 ->
                               FStar_Reflection_V2_Builtins.lookup_typ uu___4
                                 nm')) in
                   Obj.magic
                     (FStar_Tactics_Effect.tac_bind
                        (FStar_Sealed.seal
                         ...
                         (fun uu___3 ->
                            (fun s ->
                               let uu___3 =
                                 let uu___4 =
                                   fv_to_tm
                                     (FStar_Reflection_V2_Builtins.pack_fv nm) in
                                 FStar_Tactics_Effect.tac_bind
                                   (FStar_Sealed.seal
                                      (Obj.magic
                                         (FStar_Range.mk_range
  ...
  fun nm ->
    let uu___ =
          ...
          (fun uu___3 ->
             (fun uu___3 ->
                let uu___4 =
                  let uu___5 =
                    let uu___6 =
                      last (FStar_Reflection_V2_Builtins.explode_qn nm) in
                    FStar_Tactics_Effect.tac_bind
                      (FStar_Sealed.seal
                         (Obj.magic
                            (FStar_Range.mk_range
      ...
      FStar_Tactics_Effect.tac_bind
        ...
        (fun uu___2 ->
           FStar_Tactics_Effect.lift_div_tac
             (fun uu___3 -> FStar_Reflection_V2_Builtins.implode_qn uu___2)) in
    FStar_Tactics_Effect.tac_bind
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.Tactics.Parametricity.fst"
