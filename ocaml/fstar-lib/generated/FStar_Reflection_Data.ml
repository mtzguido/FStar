...
type antiquotations = (FStar_BigInt.t * FStar_Syntax_Syntax.term Prims.list)
type term_view =
  ...
  * branch Prims.list) 
  ...
  FStar_Syntax_Syntax.term FStar_Pervasives_Native.option * Prims.bool) 
  | Tv_Quoted of (FStar_Syntax_Syntax.term * antiquotations) 
  | Tv_Unknown 
...
let (__proj__Tv_Quoted__item___0 :
  term_view -> (FStar_Syntax_Syntax.term * antiquotations)) =
