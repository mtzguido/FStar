  ...
  fun env ->
    fun t ->
      ...
      | FStar_Parser_AST.Labeled uu___1 ->
          FStar_Compiler_Effect.failwith "Impossible --- labeled source term"
      ...
      let uu___ =
        ...
        let uu___2 =
          let uu___3 =
            ...
            (tm, uu___4) in
          [uu___3] in
        { FStar_Syntax_Syntax.hd = uu___1; FStar_Syntax_Syntax.args = uu___2
        } in
    ...
    fun env ->
      fun top ->
            ...
            (match name with
             ...
             | uu___1 ->
                 let uu___2 =
                   ...
                   (FStar_Errors_Codes.Fatal_EffectNotFound, uu___3) in
                 FStar_Errors.raise_error uu___2 top.FStar_Parser_AST.range)
            ...
            (match uu___1 with
             | FStar_Pervasives_Native.None ->
                 let uu___2 =
                   ...
                   (FStar_Errors_Codes.Fatal_DataContructorNotFound, uu___3) in
                 FStar_Errors.raise_error uu___2 top.FStar_Parser_AST.range
             | uu___2 ->
        ...
        | FStar_Parser_AST.Product (binders, t) ->
            ...
            (match uu___1 with
             | (bs, t1) ->
                 let rec aux env1 aqs bs1 uu___2 =
                   match uu___2 with
                   | [] ->
                       let cod =
                             ...
                             let uu___5 =
                               let uu___6 =
                                 no_annot_abs (FStar_Compiler_List.rev bs)
                                   body2 in
                               setpos uu___6 in
                             (uu___5, (FStar_Compiler_List.op_At aq aqs)))
                    | p::rest ->
                        let uu___4 = desugar_binding_pat_aq env1 p in
                        (match uu___4 with
                         | ((env2, b, pat), aq) ->
                             let pat1 =
                               match pat with
                             ...
                             (match uu___5 with
                              | (b1, sc_pat_opt1) ->
                                  aux (FStar_Compiler_List.op_At aq aqs) env2
                                    (b1 :: bs) sc_pat_opt1 rest)) in
                  ...
                  let uu___2 =
                    let uu___3 =
                      ...
                      FStar_Compiler_Util.format1
                        ...
                        uu___4 in
                    (FStar_Errors_Codes.Error_BadLetOpenRecord, uu___3) in
        ...
        | FStar_Parser_AST.LetOperator (lets, body) ->
            (match lets with
             ...
             | (letOp, letPat, letDef)::tl ->
                 let term_of_op op =
                   let uu___1 = FStar_Ident.range_of_id op in
                   FStar_Parser_AST.mk_term (FStar_Parser_AST.Op (op, []))
                     uu___1 FStar_Parser_AST.Expr in
                 let mproduct_def =
                   FStar_Compiler_List.fold_left
                     (fun def ->
                        fun uu___1 ->
                 ...
                 let fn =
                   let uu___1 =
                     let uu___2 =
                       let uu___3 =
                         let uu___4 = hoist_pat_ascription mproduct_pat in
                         [uu___4] in
                       (uu___3, body) in
                     FStar_Parser_AST.Abs uu___2 in
                   FStar_Parser_AST.mk_term uu___1
                                            ...
                                            let uu___13 =
                                              let uu___14 =
                                                FStar_Syntax_Syntax.mk_binder
                                                  x in
                                              [uu___14] in
                                            FStar_Syntax_Subst.close uu___13
                                              body2 in
                                          {
                                            FStar_Syntax_Syntax.lbs = uu___11;
                                            FStar_Syntax_Syntax.body1 =
                                              uu___12
                                          } in
                                  ...
                                  let uu___6 =
                                    let uu___7 =
                                        ...
                                        uu___9 :: uu___10 in
                                      {
                                        ...
                                        FStar_Syntax_Syntax.ret_opt =
                                          asc_opt1;
                                        FStar_Syntax_Syntax.brs = uu___8;
                                        FStar_Syntax_Syntax.rc_opt1 =
                                          FStar_Pervasives_Native.None
                                      } in
                   ...
                   | ((env1, pat1), aqP) ->
                       ...
                       (match uu___3 with
                        | (b1, aqB) ->
                            ...
                            (uu___4, (FStar_Compiler_List.op_At aqP aqB)))) in
                             ...
                             (match payload with
                              | FStar_Pervasives_Native.Some
                                  ...
                                  let record_id_t =
                                    ...
                                    let uu___5 = FStar_Ident.range_of_id cid in
                                    {
                                      FStar_Parser_AST.tm = uu___4;
                                  ...
                                  let payload_typ =
                                    ...
                                    FStar_Parser_AST.mkApp record_id_t uu___4
                                      uu___5 in
                                  let uu___4 =
                                    FStar_Compiler_Effect.op_Bar_Greater
                                      (FStar_Parser_AST.TyconRecord
                            ...
                            let uu___7 =
                              let uu___8 =
                                ...
                                FStar_Compiler_Util.format1
                                  ...
                                  uu___9 in
                              (FStar_Errors_Codes.Error_FieldShadow, uu___8) in
                          ...
                          (fun uu___3 ->
                             ...
                             | FStar_Pervasives.Inr
                                 ...
                                 let t1 =
                                   ...
                                   match uu___12 with
                                   | (env2, tpars1) ->
                                       let uu___13 = push_tparams env2 tpars1 in
                                       (match uu___13 with
                                        | (env_tps, tpars2) ->
              ...
              FStar_Errors.catch_errors
                (fun uu___3 ->
                   FStar_Options.with_saved_options
                     (fun uu___4 -> desugar_decl_noattrs attrs env d1)) in
            (match uu___2 with
             | (errs, r) ->
                 (match (errs, r) with
                        ...
                        (let uu___4 =
                         ...
                         | FStar_Pervasives_Native.Some (e, n1, n2) ->
                             (FStar_Compiler_List.iter
                              ...
                              (env0, [])))))
        | FStar_Pervasives_Native.None -> desugar_decl_noattrs attrs env d in
      match uu___ with
      | (env1, sigelts) ->
          let rec val_attrs ses =
            ...
            | {
                FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_fail
                  { FStar_Syntax_Syntax.errs = uu___1;
                    FStar_Syntax_Syntax.fail_in_lax = uu___2;
                    FStar_Syntax_Syntax.ses1 = ses1;_};
                 ...
                 let rec splice_decl meths se =
                   ...
                   | FStar_Syntax_Syntax.Sig_inductive_typ
                       ...
                       let meths1 =
                         FStar_Compiler_List.filter
                           (fun x ->
                              let uu___6 = has_no_method_attr x in
                              Prims.op_Negation uu___6) meths in
                       let is_typed = false in
                       let uu___6 =
                         let uu___7 =
                           let uu___8 =
                             let uu___9 = mkclass lid in
                             {
                               FStar_Syntax_Syntax.is_typed = is_typed;
                               FStar_Syntax_Syntax.lids2 = meths1;
                               FStar_Syntax_Syntax.tac = uu___9
                             } in
