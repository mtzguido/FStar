      ...
      (let top = FStar_Syntax_Subst.compress e in
       ...
       (match top.FStar_Syntax_Syntax.n with
        ...
        | FStar_Syntax_Syntax.Tm_quoted (qt, qi) ->
            ...
            let uu___2 = non_trivial_antiquotations qi in
            if uu___2
            then
              let e0 = e in
              let newbvs =
                ...
                let uu___3 =
                  let uu___4 =
                    FStar_Compiler_List.map
                      (fun uu___5 ->
                         match uu___5 with
                         | (t, bv') -> FStar_Syntax_Syntax.bv_to_name bv') z in
                  (Prims.int_zero, uu___4) in
                { FStar_Syntax_Syntax.antiquotations = uu___3 } in
              let nq =
                           ...
                           let uu___5 =
                             let uu___6 =
                               let uu___7 =
                                 ...
                                 FStar_Syntax_Syntax.mk_binder uu___8 in
                               [uu___7] in
                             FStar_Syntax_Subst.close uu___6 t in
                           ((false, [lb]), uu___5) in
              ...
              (let aqs =
                   ...
                   (fun uu___5 ->
                      fun aq_tm ->
                        ...
                        | (aqs_rev, guard, env_tm1) ->
                            let uu___6 = tc_term env_tm1 aq_tm in
                            (match uu___6 with
                             | (aq_tm1, uu___7, _g) ->
                                 let env_tm2 =
                                   let uu___8 =
                                   ...
                                   FStar_TypeChecker_Env.push_bv env_tm1
                                     uu___8 in
                                 let uu___8 =
                                   FStar_TypeChecker_Env.conj_guard _g guard in
                                 ((aq_tm1 :: aqs_rev), uu___8, env_tm2)))
               ...
               | (aqs_rev, guard, _env) ->
                   let qi1 =
                     {
                       FStar_Syntax_Syntax.antiquotations =
                         (Prims.int_zero, (FStar_Compiler_List.rev aqs_rev))
                     } in
                   let tm =
                     FStar_Syntax_Syntax.mk
                       (FStar_Syntax_Syntax.Tm_quoted (qt, qi1))
                   ...
                   value_check_expected_typ env1 tm
                     (FStar_Pervasives.Inl FStar_Syntax_Syntax.t_term) guard)
                               ...
                               let r1 =
                                 ...
                                 | ((t2, uu___7), uu___8, uu___9)::uu___10 ->
                                     ...
                                     let uu___12 =
                                       ...
                                       FStar_Compiler_Range.union_rng uu___13
                                         uu___14 in
...
let rec (universe_of_aux :
  ...
  fun env ->
    fun e ->
      ...
      | FStar_Syntax_Syntax.Tm_match (uu___1, uu___2, b::uu___3, uu___4) ->
          let uu___5 = FStar_Syntax_Subst.open_branch b in
          (match uu___5 with
           | (pat, uu___6, tm) ->
               let bvs = FStar_Syntax_Syntax.pat_bvs pat in
