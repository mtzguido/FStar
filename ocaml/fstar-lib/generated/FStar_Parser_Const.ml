...
let (binder_lid : FStar_Ident.lident) =
  FStar_Ident.lid_of_path ["FStar"; "Reflection"; "Stubs"; "Types"; "binder"]
    FStar_Compiler_Range_Type.dummyRange
let (binders_lid : FStar_Ident.lident) =
  FStar_Ident.lid_of_path
    ["FStar"; "Reflection"; "Stubs"; "Types"; "binders"]
    FStar_Compiler_Range_Type.dummyRange
let (bv_lid : FStar_Ident.lident) =
  FStar_Ident.lid_of_path ["FStar"; "Reflection"; "Stubs"; "Types"; "bv"]
    FStar_Compiler_Range_Type.dummyRange
let (fv_lid : FStar_Ident.lident) =
  FStar_Ident.lid_of_path ["FStar"; "Reflection"; "Stubs"; "Types"; "fv"]
    FStar_Compiler_Range_Type.dummyRange
