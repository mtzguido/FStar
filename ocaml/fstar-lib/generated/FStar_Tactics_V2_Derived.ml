...
let fail_doc_at :
  ...
  fun m ->
    fun r ->
      let uu___ = map_optRO FStar_Tactics_V2_Builtins.fixup_range r in
      FStar_Tactics_Effect.tac_bind
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "FStar.Tactics.V2.Derived.fst"
        ...
        (fun r1 ->
           FStar_Tactics_Effect.raise
             (FStar_Tactics_Common.TacticFailure (m, r1)))
let fail_doc :
  'a .
    FStar_Errors_Msg.error_message ->
  ...
  fun m ->
    FStar_Tactics_Effect.raise
      (FStar_Tactics_Common.TacticFailure (m, FStar_Pervasives_Native.None))
let fail_at :
  'a .
    Prims.string ->
      FStar_Range.range FStar_Pervasives_Native.option ->
        ('a, unit) FStar_Tactics_Effect.tac_repr
  = fun m -> fun r -> fail_doc_at (FStar_Errors_Msg.mkmsg m) r
...
let fail_silently_doc :
  ...
  =
  fun m ->
    let uu___ = FStar_Tactics_V2_Builtins.set_urgency Prims.int_zero in
    FStar_Tactics_Effect.tac_bind
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.Tactics.V2.Derived.fst"
...
let fail_silently :
  ...
  fun m -> fail_silently_doc (FStar_Errors_Msg.mkmsg m)
let (_cur_goal :
...
let (cur_vars :
  ...
  fun uu___ ->
    ...
    FStar_Tactics_Effect.tac_bind
      ...
      (fun uu___2 ->
         FStar_Tactics_Effect.lift_div_tac
           (fun uu___3 -> FStar_Reflection_V2_Builtins.vars_of_env uu___2))
let with_policy :
  'a .
  ...
  fun pol ->
    fun f ->
      let uu___ = FStar_Tactics_V2_Builtins.get_guard_policy () in
      FStar_Tactics_Effect.tac_bind
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "FStar.Tactics.V2.Derived.fst"
        ...
        (fun uu___1 ->
           (fun old_pol ->
              let uu___1 = FStar_Tactics_V2_Builtins.set_guard_policy pol in
              Obj.magic
                (FStar_Tactics_Effect.tac_bind
                   (FStar_Sealed.seal
                      (Obj.magic
    ...
    FStar_Tactics_Effect.tac_bind
      ...
      (fun uu___2 ->
         (fun uu___2 ->
            ...
            | uu___3::gs ->
                Obj.magic (FStar_Tactics_V2_Builtins.set_goals gs)) uu___2)
              ...
              (FStar_Tactics_Effect.tac_bind
                 ...
                 (fun uu___3 ->
                    (fun uu___3 ->
                       ...
                       | g1::g2::gs1 ->
                           Obj.magic
                             (FStar_Tactics_V2_Builtins.set_goals (g2 :: g1
                                :: gs1))) uu___3))) uu___2)
    ...
    FStar_Tactics_Effect.tac_bind
      ...
      (fun uu___2 ->
         (fun uu___2 ->
            ...
            | (g::gs, gs') ->
                let uu___3 = FStar_Tactics_V2_Builtins.set_goals gs in
                Obj.magic
                  (FStar_Tactics_Effect.tac_bind
                     (FStar_Sealed.seal
                        (Obj.magic
...
let (cur_module :
  ...
  =
  fun uu___ ->
    let uu___1 = FStar_Tactics_V2_Builtins.top_env () in
    FStar_Tactics_Effect.tac_bind
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.Tactics.V2.Derived.fst"
      ...
      (fun uu___2 ->
         FStar_Tactics_Effect.lift_div_tac
           (fun uu___3 -> FStar_Reflection_V2_Builtins.moduleof uu___2))
let (open_modules :
  unit ->
  ...
  fun uu___ ->
    ...
    FStar_Tactics_Effect.tac_bind
      ...
      (fun uu___2 ->
         FStar_Tactics_Effect.lift_div_tac
           (fun uu___3 ->
              FStar_Reflection_V2_Builtins.env_open_modules uu___2))
let (fresh_uvar :
  ...
  fun o ->
    ...
    FStar_Tactics_Effect.tac_bind
      ...
      (fun uu___1 ->
         (fun e -> Obj.magic (FStar_Tactics_V2_Builtins.uvar_env e o)) uu___1)
let (unify :
  FStar_Tactics_NamedView.term ->
    FStar_Tactics_NamedView.term ->
                ...
                Obj.magic
                  (FStar_Tactics_Effect.tac_bind
                     ...
                     (fun uu___3 ->
                        (fun sgs ->
                           let uu___3 =
                             FStar_Tactics_V2_Builtins.set_goals [g] in
                           Obj.magic
                             (FStar_Tactics_Effect.tac_bind
                                (FStar_Sealed.seal
                                   (Obj.magic
    ...
    FStar_Tactics_Effect.tac_bind
      ...
      (fun uu___1 ->
         (fun uu___1 ->
            match uu___1 with
            | (gs, sgs) ->
                let uu___2 = FStar_Tactics_V2_Builtins.set_goals sgs in
                Obj.magic
                  (FStar_Tactics_Effect.tac_bind
                     (FStar_Sealed.seal
                        (Obj.magic
                     ...
                     (fun uu___3 ->
                        (fun uu___3 ->
                           let uu___4 =
                             FStar_Tactics_V2_Builtins.set_smt_goals [] in
                           Obj.magic
                             (FStar_Tactics_Effect.tac_bind
                                (FStar_Sealed.seal
                                   (Obj.magic
        ...
        FStar_Tactics_Util.repeatn n
          (fun uu___1 ->
             (fun uu___1 ->
                Obj.magic
                  (FStar_Tactics_Effect.lift_div_tac
                     (fun uu___2 -> FStar_Reflection_V2_Data.Q_Explicit)))
               uu___1) in
      FStar_Tactics_Effect.tac_bind
        (FStar_Sealed.seal
           (Obj.magic
...
let (fresh_namedv :
  ...
  =
  fun uu___ ->
    let uu___1 = FStar_Tactics_V2_Builtins.fresh () in
    FStar_Tactics_Effect.tac_bind
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.Tactics.V2.Derived.fst"
...
let rec repeat :
  ...
  =
  fun t ->
    let uu___ = FStar_Tactics_V2_Builtins.catch t in
    FStar_Tactics_Effect.tac_bind
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.Tactics.V2.Derived.fst"
    ...
    fun t ->
      let uu___ =
        try_with (fun uu___1 -> match () with | () -> cur_env ())
          (fun uu___1 -> FStar_Tactics_V2_Builtins.top_env ()) in
      FStar_Tactics_Effect.tac_bind
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "FStar.Tactics.V2.Derived.fst"
    ...
    FStar_Tactics_Effect.tac_bind
      ...
      (fun uu___2 ->
         (fun uu___2 ->
            match uu___2 with
            | (gs, sgs) ->
                let uu___3 = FStar_Tactics_V2_Builtins.set_smt_goals [] in
                Obj.magic
                  (FStar_Tactics_Effect.tac_bind
                     (FStar_Sealed.seal
                        (Obj.magic
                     ...
                     (fun uu___4 ->
                        (fun uu___4 ->
                           let uu___5 =
                             FStar_Tactics_V2_Builtins.set_goals sgs in
                           Obj.magic
                             (FStar_Tactics_Effect.tac_bind
                                (FStar_Sealed.seal
                                   (Obj.magic
...
let (destruct :
  ...
  =
  fun tm ->
    let uu___ = FStar_Tactics_V2_Builtins.t_destruct tm in
    FStar_Tactics_Effect.tac_bind
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.Tactics.V2.Derived.fst"
...
let (destruct_intros :
  ...
  fun tm ->
    seq
      (fun uu___ ->
         let uu___1 = FStar_Tactics_V2_Builtins.t_destruct tm in
         FStar_Tactics_Effect.tac_bind
           (FStar_Sealed.seal
              (Obj.magic
                 (FStar_Range.mk_range "FStar.Tactics.V2.Derived.fst"
...
let (intro_as :
  ...
  =
  fun s ->
    let uu___ = FStar_Tactics_V2_Builtins.intro () in
    FStar_Tactics_Effect.tac_bind
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.Tactics.V2.Derived.fst"
  ...
  fun x ->
    op_Less_Bar_Greater
      (op_Less_Bar_Greater (fun uu___ -> FStar_Tactics_V2_Builtins.rewrite x)
         (fun uu___ ->
            let uu___1 = FStar_Tactics_V2_Builtins.var_retype x in
            FStar_Tactics_Effect.tac_bind
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range "FStar.Tactics.V2.Derived.fst"
                  ...
                  (FStar_Tactics_Effect.tac_bind
                     ...
                     (fun uu___3 ->
                        (fun n ->
                           Obj.magic
                             (FStar_Tactics_V2_Builtins.norm
                                [FStar_Pervasives.delta_fully [n]])) uu___3))
      ...
      (fun uu___1 ->
         (fun uu___1 ->
            ...
            | FStar_Reflection_V2_Formula.Comp
                ...
                let uu___3 = FStar_Tactics_V2_Builtins.grewrite l r in
                Obj.magic
                  (FStar_Tactics_Effect.tac_bind
                     (FStar_Sealed.seal
                        (Obj.magic
                     ...
                     (fun uu___4 ->
                        (fun uu___4 ->
                           ...
                           | FStar_Reflection_V2_Formula.Comp
                               ...
                               ->
                               let uu___6 =
                                 FStar_Tactics_V2_Builtins.grewrite l r in
                               Obj.magic
                                 (FStar_Tactics_Effect.tac_bind
                                    (FStar_Sealed.seal
                                       (Obj.magic
...
let (admit_dump_t : unit -> (unit, unit) FStar_Tactics_Effect.tac_repr) =
  fun uu___ ->
    let uu___1 = FStar_Tactics_V2_Builtins.dump "Admitting" in
    FStar_Tactics_Effect.tac_bind
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.Tactics.V2.Derived.fst"
...
let (change_with :
  ...
  fun t1 ->
    fun t2 ->
      focus
        (fun uu___ ->
           let uu___1 = FStar_Tactics_V2_Builtins.grewrite t1 t2 in
           FStar_Tactics_Effect.tac_bind
             (FStar_Sealed.seal
                (Obj.magic
                   (FStar_Range.mk_range "FStar.Tactics.V2.Derived.fst"
...
let solve_then :
  ...
  fun t1 ->
    fun t2 ->
      let uu___ = FStar_Tactics_V2_Builtins.dup () in
      FStar_Tactics_Effect.tac_bind
        (FStar_Sealed.seal
           (Obj.magic
              (FStar_Range.mk_range "FStar.Tactics.V2.Derived.fst"
                    ...
                    (FStar_Tactics_Effect.lift_div_tac
                       (fun uu___3 ->
                          FStar_Tactics_Types.set_label
                            (Prims.strcat l (FStar_Tactics_Types.get_label h))
                            h)) in
                Obj.magic
                  (FStar_Tactics_Effect.tac_bind
                     (FStar_Sealed.seal
                     ...
                     (fun uu___3 ->
                        (fun h1 ->
                           Obj.magic
                             (FStar_Tactics_V2_Builtins.set_goals (h1 :: t)))
                          uu___3))) uu___1)
  ...
  fun uu___ ->
    let uu___1 =
      ...
      FStar_Tactics_Effect.tac_bind
        ...
        (fun uu___3 ->
           (fun uu___3 ->
              Obj.magic (FStar_Tactics_V2_Builtins.set_goals uu___3)) uu___3) in
    FStar_Tactics_Effect.tac_bind
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "FStar.Tactics.V2.Derived.fst"
      ...
      (fun uu___2 ->
         (fun uu___2 ->
            Obj.magic (FStar_Tactics_V2_Builtins.set_smt_goals [])) uu___2)
let rec extract_nth :
  'a .
    Prims.nat ->
      ...
      (fun uu___1 ->
         (fun uu___1 ->
            ...
            | FStar_Pervasives_Native.Some (h, t) ->
                Obj.magic (FStar_Tactics_V2_Builtins.set_goals (h :: t)))
           uu___1)
                  ...
                  (FStar_Tactics_Effect.tac_bind
                     ...
                     (fun uu___3 ->
                        (fun uu___3 ->
                           ...
                           | (FStar_Tactics_NamedView.Tv_FVar fv,
                              (uu___4, FStar_Reflection_V2_Data.Q_Implicit)::
                              (a1, FStar_Reflection_V2_Data.Q_Explicit)::
                              (a2, FStar_Reflection_V2_Data.Q_Explicit)::[])
                               ->
                               Obj.magic
    ...
    focus
      (fun uu___1 ->
         ...
         FStar_Tactics_Effect.tac_bind
           ...
           (fun uu___3 ->
              (fun x ->
                 let uu___3 = FStar_Tactics_V2_Builtins.t_destruct x in
                 Obj.magic
                   (FStar_Tactics_Effect.tac_bind
                      (FStar_Sealed.seal
                         (Obj.magic
                         ...
                         (fun uu___4 ->
                            Obj.magic
                              (iterAll
                                 (fun uu___5 ->
                                    let uu___6 =
                                      repeat FStar_Tactics_V2_Builtins.intro in
                                    FStar_Tactics_Effect.tac_bind
                                      (FStar_Sealed.seal
                                         (Obj.magic
                                            (FStar_Range.mk_range
  ...
  fun n ->
    ...
    FStar_Tactics_Effect.tac_bind
      ...
      (fun uu___1 ->
         (fun nv ->
            let uu___1 =
              FStar_Tactics_Unseal.unseal nv.FStar_Reflection_V2_Data.sort in
            Obj.magic
              (FStar_Tactics_Effect.tac_bind
                 (FStar_Sealed.seal
                    (Obj.magic
          ...
          FStar_Tactics_Util.fold_left
            (fun uu___1 ->
               fun uu___2 ->
                 ...
                 | ((e1, lb_bvs), (i, v)) ->
                     let uu___3 =
                       FStar_Tactics_V2_Builtins.push_bv_dsenv e1 i in
                     FStar_Tactics_Effect.tac_bind
                       (FStar_Sealed.seal
                          (Obj.magic
                             (FStar_Range.mk_range
                    ...
                    Obj.magic
                      (FStar_Tactics_Effect.tac_bind
                         ...
                         (fun uu___3 ->
                            (fun uu___3 ->
                               let uu___4 =
                                 FStar_Tactics_V2_Builtins.string_to_term e1
                                   t in
                               Obj.magic
                                 (FStar_Tactics_Effect.tac_bind
                                    (FStar_Sealed.seal
