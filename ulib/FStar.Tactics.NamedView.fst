...
module RD = FStar.Reflection.V2.Stubs.Data
...
let tcc (e:env) (t:term) : Tac comp =
  let c : R.comp = V2.Stubs.Builtins.tcc e t in
  R.inspect_comp c

let comp_to_string (c:comp) : Tac string = V2.Stubs.Builtins.comp_to_string (R.pack_comp c)
