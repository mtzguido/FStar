...
let load_native_tactics () =
    ...
    let cmxs_file m =
        ...
        match FStarC.Options.find_file cmxs with
        | Some f -> f
        | None ->
          ...
          then E.raise_error0 E.Fatal_FailToCompileNativeTactic (Util.format1 "Could not find %s to load" cmxs)
            ...
            match FStarC.Options.find_file (ml_file m) with
            | None ->
            ...
            | Some ml ->
              ...
              FStarC.Compiler.Plugins.compile_modules dir [ml_module_name m];
              begin match FStarC.Options.find_file cmxs with
                | None ->
                  E.raise_error0 E.Fatal_FailToCompileNativeTactic
    ...
    FStarC.Compiler.Plugins.load_plugins cmxs_files;
    iter_opt (Options.use_native_tactics ())
      FStarC.Compiler.Plugins.load_plugins_dir;
    ()
