...
let binder_lid = lid_of_path (["FStar"; "Reflection"; "Stubs"; "Types"; "binder"]) FStar.Compiler.Range.dummyRange
let binders_lid = lid_of_path (["FStar"; "Reflection"; "Stubs"; "Types"; "binders"]) FStar.Compiler.Range.dummyRange
let bv_lid = lid_of_path (["FStar"; "Reflection"; "Stubs"; "Types"; "bv"]) FStar.Compiler.Range.dummyRange
let fv_lid = lid_of_path (["FStar"; "Reflection"; "Stubs"; "Types"; "fv"]) FStar.Compiler.Range.dummyRange
...
let term_lid       = p2l ["FStar"; "Reflection"; "Stubs"; "Types"; "term"]
let ctx_uvar_and_subst_lid = p2l ["FStar"; "Reflection"; "Stubs"; "Types"; "ctx_uvar_and_subst"]
let universe_uvar_lid      = p2l ["FStar"; "Reflection"; "Stubs"; "Types"; "universe_uvar"]
let check_with_lid = lid_of_path (["FStar"; "VConfig"; "check_with"]) FStar.Compiler.Range.dummyRange

let decls_lid      = p2l ["FStar"; "Reflection"; "Stubs"; "Types"; "decls"]
