...
(* FIXME: NONE OF THIS SHOULD LIVE HERE! *)
let compiler_effect_lid          = p2l ["FStarC"; "Compiler"; "Effect"]
let compiler_effect_ALL_lid      = p2l ["FStarC"; "Compiler"; "Effect"; "ALL"]
let compiler_effect_ML_lid       = p2l ["FStarC"; "Compiler"; "Effect"; "ML"]
let compiler_effect_failwith_lid = p2l ["FStarC"; "Compiler"; "Effect"; "failwith"]
let compiler_effect_try_with_lid = p2l ["FStarC"; "Compiler"; "Effect"; "try_with"]
...
let check_with_lid = lid_of_path (["FStar"; "VConfig"; "check_with"]) FStarC.Compiler.Range.dummyRange
