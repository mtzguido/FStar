...
let _ =
  ...
  assert_norm (add_underspec 3sz 2sz == 5sz);
  assert_norm (sub_underspec 3sz 2sz == 1sz);
  assert_norm (mul_underspec 3sz 2sz == 6sz);
  assert_norm (1sz `add_underspec` 2sz `add_underspec` 3sz `add_underspec` 4sz == 10sz);
  ()
