(* This file overrides src/ml/FStarC_Parser_LexFStar.ml, which
   requires sedlex 3.6. This version works with sedlex 3.4 which
   is the latest one currently in nixpkgs. *)
